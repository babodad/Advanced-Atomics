...
if AA.TreeContrast == "low" then
	data.raw["utility-constants"]["default"]["chart"]["default_color_by_type"].tree = {a = 0.1, r = 0.1, g = 0.4, b = 0.1}
elseif AA.TreeContrast == "medium"  then
	data.raw["utility-constants"]["default"]["chart"]["default_color_by_type"].tree = {a = 0.5, r = 0.1, g = 0.4, b = 0.1}    
elseif AA.TreeContrast == "high"  then
	data.raw["utility-constants"]["default"]["chart"]["default_color_by_type"].tree = {a = 0.8, r = 0.1, g = 0.6, b = 0.1}      
end
